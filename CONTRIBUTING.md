...
4. Send raw ESC/POS bytes to `/tmp/pos_printer` or use the test functionality in a different terminal when the 
...
If you encounter behavior that does not respect these expectations, report it through the repository issue 
tracker.
